...
if st.session_state.uploaded_file_:
    ...
    if uploaded_file is not None:
        ...
        __Probabilistic__ picks the value/token randomly using the distribution of the predictions.''', key='predict_type', on_change=predict_type_change)
