...
- [Streamlit Tutorial - Image Captioning With Visual Attention](#streamlit-tutorial---image-captioning-with-visual-attention)
  - [Project Goal](#project-goal)
  - [Neural Network Architecture](#neural-network-architecture)
  - [Webapp via Streamlit](#webapp-via-streamlit)
    - [Feedback Storage](#feedback-storage)
    - [Usage](#usage)
  - [References](#references)

# Streamlit Tutorial - Image Captioning With Visual Attention 
This repository contains an example of how to use `streamlit` for developing machine learning web apps.
